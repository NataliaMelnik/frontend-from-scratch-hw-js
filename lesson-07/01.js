...
nextButton.addEventListener('click', function() {
  ...
  let indImage = WEB_TECH_IMAGES.indexOf(image.src)

  if (indImage<WEB_TECH_IMAGES.length-1) {
    
    image.src = WEB_TECH_IMAGES[indImage+1];
  } else {
...
prevButton.addEventListener('click', function() {
  ...
  if (indImage===0) {
    ...
    image.src = WEB_TECH_IMAGES[WEB_TECH_IMAGES.length-1];
  } else {
    image.src = WEB_TECH_IMAGES[indImage-1];
  }
